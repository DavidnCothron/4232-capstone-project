...
public class CaveTileGround : Tile {
	...
	public override void GetTileData (Vector3Int position, ITilemap tilemap, ref TileData tileData) {
		...
		*/
		...
		if(composition[1] == 'N' && composition[3] == 'G' &&
		...
		*/
		...
		/*
			...
			[0]	3	[5]
		*/
		if (composition[0] == 'G' && composition[1] == 'G' && composition[3] == 'N' && composition[4] == 'N' && composition[5] == 'G' && composition[6] == 'G') {
			tileData.sprite = center [(int)Random.Range (3, 4)];
		}
		...
		*/
		if (composition[1] == 'G' && composition[3] == 'G' && composition[4] == 'G' && composition[6] == 'G') {
			tileData.sprite = bottom [(int)Random.Range (0, 8)];
		}
